...
def getOption():
    ...
    #### data parameters ####
    #########################
    parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/ImageNetS50/train",
    ...
    parser.add_argument("--wd", default=0.000001, type=float, help="weight decay")
    ...
    parser.add_argument("--pretrained", default="/root/autodl-tmp/PASS-jittor/checkpoints/ckp-199.pth.tar", type=str, help="path to pretrained weights")
    parser.add_argument("--num_classes", type=int, default=50, help="the number of classes")
    # 放自监督训练后的标签
    parser.add_argument("--pseudo_path", type=str, default='/root/autodl-tmp/PASS-jittor/train', help="the path to generated labels")
    ...
    parser.add_argument("--dump_path", type=str, default="/root/autodl-tmp/PASS-jittor/checkpoints/",
