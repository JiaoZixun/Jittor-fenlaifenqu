...
def parse_args():
    ...
    parser.add_argument("--mode", type=str, default='validation', required=True)
    parser.add_argument("--dump_path", type=str, default='./result', help="The path to save results.")
    parser.add_argument("--data_path", type=str, default='/root/autodl-tmp/TestB', help="The path to ImagenetS dataset.")
    parser.add_argument("--pretrained", type=str, default='./checkpoints/checkpoint.pth.tar', help="The model checkpoint file.")
    parser.add_argument("-a", "--arch", metavar="ARCH", default='resnet50', help="The model architecture.")
    parser.add_argument("-c", "--num-classes", default=50, type=int, help="The number of classes.")
    parser.add_argument("-t", "--threshold", default=0.26, type=float, help="The threshold to filter the 'others' categroies.")
    parser.add_argument("--test", action='store_true', help="whether to save the logit. Enabled when finding the best threshold.")
    parser.add_argument("--centroid", type=str, default='./checkpoints/centroids.npy', help="The centroids of clustering.")
...
def main_worker(args):
    ...
    for images, path, height, width in tqdm(dataloader):
        ...
        with jt.no_grad():
            ...
            out = out.view(B, C, -1).permute(0, 2, 1).view(-1, C)
