...
def parse_args():
    ...
    parser.add_argument("--dump_path", type=str, default='.', help="The path to save results.")
    parser.add_argument("--data_path", type=str, default='/root/autodl-tmp/ImageNetS50', help="The path to ImagenetS dataset.")
    parser.add_argument("--pretrained", type=str, default='/root/autodl-tmp/PASS-jittor/checkpoint.pth.tar', help="The model checkpoint file.")
    ...
    parser.add_argument("--centroid", type=str, default='/root/autodl-tmp/PASS-jittor/cluster/centroids.npy', help="The centroids of clustering.")
